...
import { View, FlatList, ScrollView, StyleSheet, StatusBar, Text } from 'react-native';
    ...
    <View style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.appHeader}>
          ...
          <Text style={styles.studentInfo}>• Riyan Shrestha •</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  safeArea: {
    flex: 1,
    backgroundColor: '#fff',
    paddingTop: 45   // fixed safe spacing for status bar
  },
